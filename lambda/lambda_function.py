...
def lambda_handler(event, context):
    ...
    print("LOG: msg: ", str(msg))

    ENDPOINT_NAME = "sms-spam-classifier-mxnet-2021-11-29-20-08-02-903"
    ...
    print("len of test_msg: ", len(test_messages[0]))
